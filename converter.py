...
def converter(batchno, brewdate,in_path, out_path, excel_layout = 'brewsheet_empty.xlsx'):
    ...
    df = [
        ...
        [locals().get('malt1', None), None, None, None,None, locals().get('hop1', None), None, locals().get('hopAlpha1', None), None, None, None, locals().get('yeast1', None), None],
        [locals().get('malt2', None), None, None, None,None, locals().get('hop2', None), None, locals().get('hopAlpha2', None), None, None, None, locals().get('yeast2', None), None],
        [locals().get('malt3', None), None, None, None,None, locals().get('hop3', None), None, locals().get('hopAlpha3', None), None, None, None, locals().get('yeast3', None), None],
        [locals().get('malt4', None), None, None, None,None, locals().get('hop4', None), None, locals().get('hopAlpha4', None), None, None, None, locals().get('yeast4', None), None],
        [locals().get('malt5', None), None, None, None,None, locals().get('hop5', None), None, locals().get('hopAlpha5', None), None, None, None, locals().get('yeast5', None), None],
        [locals().get('malt6', None), None, None, None,None, locals().get('hop6', None), None, locals().get('hopAlpha6', None), None, None, None, locals().get('yeast6', None), None],
        [locals().get('malt7', None), None, None, None,None, locals().get('hop7', None), None, locals().get('hopAlpha7', None), None, None, None, locals().get('yeast7', None), None],
        ...
        ["pH (10mins) [pH]",None,None,mashpH - 0.1,mashpH,mashpH+0.1,"Step1",locals().get('mashStepTemp1', None),locals().get('mashStepDur1', None),None,None,None,None,None,None],
        ["Korrektur LA [ml]",None,None,0,0,50,"Step2",locals().get('mashStepTemp2', None),locals().get('mashStepDur2', None),None,None,None,None,None,None],
        [None,None,None,None,None,None,"Step3",locals().get('mashStepTemp3', None),locals().get('mashStepDur3', None),None,None,None,None,None,None],
        ["Wasser [l]",None,None,mashWaterAmount - 10,mashWaterAmount,160,"Step4",locals().get('mashStepTemp4', None),locals().get('mashStepDur4', None),None,None,None,None,None,None],
        ["Malz [kg]",None,None,None,mashMaltAmount,None,"Step5",locals().get('mashStepTemp5', None),locals().get('mashStepDur5', None),None,None,None,None,None,None],
        ["Gussführung",None,None,None,Gussführung,None,"Step6",locals().get('mashStepTemp6', None),locals().get('mashStepDur6', None),None,None,None,None,None,None],
        ...
        ["preBoil pH",None,None,mashpH-0.2,mashpH,mashpH+0.2,locals().get('hopdose1',None),locals().get('hopdoseTime1',None),locals().get('hopdoseAmount1',None),None,None,None,None,None,None],
        ["preBoil °P",None,None,preBoilGravity-0.1,preBoilGravity,preBoilGravity+0.1,locals().get('hopdose2',None),locals().get('hopdoseTime2',None),locals().get('hopdoseAmount2',None),None,None,None,None,None,None],
        ["preBoil Volume",None,None,preBoilVolume-20,preBoilVolume,preBoilVolume+20,locals().get('hopdose3',None),locals().get('hopdoseTime3',None),locals().get('hopdoseAmount3',None),None,None,None,None,None,None],
        ["preBoil LA [ml]",None,None,0,0,50,locals().get('hopdose4',None),locals().get('hopdoseTime4',None),locals().get('hopdoseAmount4',None),None,None,None,None,None,None],
        [None,None,None,None,None,None,locals().get('hopdose5',None),locals().get('hopdoseTime5',None),locals().get('hopdoseAmount5',None),None,None,None,None,None,None],
        ["postBoil pH",None,None,mashpH-0.5,mashpH-0.4,mashpH-0.3,locals().get('hopdose6',None),locals().get('hopdoseTime6',None),locals().get('hopdoseAmount6',None),None,None,None,None,None,None],
        ["postBoil °P",None,None,og-0.1,og,og+0.1,locals().get('hopdose7',None),locals().get('hopdoseTime7',None),locals().get('hopdoseAmount7',None),None,None,None,None,None,None],
        ["postBoil Volume",None,None,postBoilVolume - 10,postBoilVolume,postBoilVolume + 10,locals().get('hopdose8',None),locals().get('hopdoseTime8',None),locals().get('hopdoseAmount8',None),None,None,None,None,None,None],
        ["postBoil LA [ml]",None,None,0,0,50,locals().get('hopdose9',None),locals().get('hopdoseTime9',None),locals().get('hopdoseAmount9',None),None,None,None,None,None,None],
        [None,None,None,None,None,None,locals().get('hopdose10',None),locals().get('hopdoseTime10',None),locals().get('hopdoseAmount10',None),None,None,None,None,None,None],
    ...
    df2 = [
        ...
        ["Hefemenge",None,None,None,fermYeastAmount,None,1,locals().get('fermStepName1',None),None,locals().get('fermStepTemp1',None),locals().get('fermStepPressure1',None),"Kegs 20l",None,None,None,None],
        ["Gen",None,None,None,None,None,2,locals().get('fermStepName2',None),None,locals().get('fermStepTemp2',None),locals().get('fermStepPressure2',None),"Kegs 50l",None,None,None,None],
        ["Viability",None,None,None,None,None,3,locals().get('fermStepName3',None),None,locals().get('fermStepTemp3',None),locals().get('fermStepPressure3',None),"Flaschen 0.5",None,None,None,None],
        ["Stammwürze",None,None,og-0.1,og,og+0.1,4,locals().get('fermStepName4',None),None,locals().get('fermStepTemp4',None),locals().get('fermStepPressure4',None),"Flaschen 0.3",None,None,None,None],
        ["Restextrakt",None,None,round((fg-0.1),1),fg,round((fg+0.1),1),5,locals().get('fermStepName5',None),None,locals().get('fermStepTemp5',None),locals().get('fermStepPressure5',None),"Direktausschank",None,None,None,None],
        ["pH" ,None,None,round((mashpH-1.5),2),round((mashpH-1.4),2),round((mashpH-1.3),2),6,locals().get('fermStepName6',None),None,locals().get('fermStepTemp6',None),locals().get('fermStepPressure6',None),None,None,None,None,None],
        ["Alkoholgehalt",None,None,round((abv-0.1),1),abv,round((abv+0.1),1),7,locals().get('fermStepName7',None),None,locals().get('fermStepTemp7',None),locals().get('fermStepPressure7',None),None,None,None,None,None],
